...
public class AppExecutor {
    ...
    {
        if(instanceExecutor == null) synchronized (LOCK)
        {
            instanceExecutor = new AppExecutor(Executors.newSingleThreadExecutor(), Executors.newFixedThreadPool(3), new MainThreadHandler());
        }
